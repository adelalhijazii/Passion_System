...
namespace Passion.Areas.Admin.Controllers
{
    ...
    public class MasterPricingController : Controller
    {
        ...
        public async Task<ActionResult> Create(MasterPricingViewModel collection)
        {
            try
            {
                ...
                var data = new MasterPricing
                {
                    ...
                    MasterPricingIcon = collection.MasterPricingIcon,
                    ...
                    MasterPricingList = collection.MasterPricingList,
        ...
        public ActionResult Edit(int id)
        {
            ...
            pricingmodel.MasterPricingIcon = data.MasterPricingIcon;
            ...
            pricingmodel.MasterPricingList = data.MasterPricingList;
