...
namespace Passion.Areas.Admin.Controllers
{
    ...
    public class MasterFeaturesController : Controller
    {
        ...
        public async Task<ActionResult> Create(MasterFeaturesViewModel collection)
        {
            try
            {
                ...
                var data = new MasterFeatures
                {
                    ...
                    MasterFeaturesBreef = collection.MasterFeaturesBreef,
                    MasterFeaturesNumber = collection.MasterFeaturesNumber,
                    CreateUser = user.Id,
        ...
        public ActionResult Edit(int id)
        {
            ...
            featuresmodel.MasterFeaturesBreef = data.MasterFeaturesBreef;
            featuresmodel.MasterFeaturesNumber = data.MasterFeaturesNumber;
