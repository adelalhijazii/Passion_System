...
builder.Services.AddScoped<IRepository<MasterChooseCategory>, MasterChooseCategoryRepository>();
builder.Services.AddScoped<IRepository<MasterChooseItemMenu>, MasterChooseItemMenuRepository>();
builder.Services.AddScoped<IRepository<MasterContactUsInformation>, MasterContactUsInformationRepository>();
builder.Services.AddScoped<IRepository<MasterContactUs>, MasterContactUsRepository>();
...
builder.Services.AddScoped<IRepository<MasterHowWeWork>, MasterHowWeWorkRepository>();
